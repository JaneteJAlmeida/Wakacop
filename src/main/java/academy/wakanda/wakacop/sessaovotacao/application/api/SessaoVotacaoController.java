...
public class SessaoVotacaoController implements SessaoVotacaoAPI {
    ...
    public SessaoAberturaResponse abreSessao(SessaoAberturaRequest sessaoAberturaRequest) {
        log.info("[start] SessaoVotacaoController - abre sessao");
        SessaoAberturaResponse sessaoVotacaoResponse = sessaoAberturaService.abreSessao(sessaoAberturaRequest);
        log.info("[finish] SessaoVotacaoController - abre sessao");
